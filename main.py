...
set_default_color_theme(resource_path("cherry (1).json"))
...
class MainWindow(CTk):
    def __init__(self):
        ...
        # main
        self.username = name
        self.name_lbl = CTkLabel(self, text="Новий котик у чаті, " + self.username)
        self.name_lbl.pack()
        ...
        self.message_entry = CTkEntry(self.bottom_row,
                                      placeholder_text="шкрябай туто:",
                                      height=40)
        self.message_entry.pack(fill="x", side="left", expand=True)
        self.send_button = CTkButton(self.bottom_row, text=">", width=50, height=40, command=self.send_message)
